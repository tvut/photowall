<script lang="ts">
	...
	let status = $derived(post.status);
	let displayTime = $derived(post.displayTime);
	...
	<div class="card-body">
		...
		<div class="space-y-6">
			<div class="form-control w-full">
				...
				>
					<option value="draft" class={status === 'draft' ? 'bg-primary-content' : ''}>Draft</option
					>
			...
			<div class="space-x-2">
				...
				<button class="btn btn-error w-40" onclick={handleDelete} disabled={isDeleting}>
